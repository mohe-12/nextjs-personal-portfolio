...
const Contact = ({isDarkMode}) => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "39a84a0f-8c8e-4242-94cf-c85e2b312c65");
    ...
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-[length:90%_auto]'>
      ...
      <h2 className='text-center text-5xl font-Ovo'>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            >Submit now <Image src='/right-arrow-white.png' alt='right arrow' className='w-4' width={300} height={300}/></button>
